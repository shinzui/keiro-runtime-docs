...
<Callout type="warn">
  **Breaking API changes:** current docs describe `shibuya-core 0.9.0.1`. New
  ...
  document their compatible release lines separately. The reviewed Message DB
  adapter still requires Shibuya core 0.5 and cannot be selected with core 0.8;
  see [compatibility and upgrades](/docs/getting-started/compatibility-and-upgrades).
</Callout>
