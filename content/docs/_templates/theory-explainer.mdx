...
<Callout type="info">
  This page goes deeper than the surrounding explanation pages. You can use the library fully
  without reading it; read it to understand the model precisely.
</Callout>
