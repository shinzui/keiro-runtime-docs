...
<Callout type="info">
  This is a tutorial: a guided lesson. Follow every step in order. You do not need prior knowledge
  of [product] beyond [the one prerequisite]. By the end you will have [the concrete artifact].
</Callout>
