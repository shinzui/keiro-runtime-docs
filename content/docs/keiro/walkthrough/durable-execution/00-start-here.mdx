...
<Cards>
  ...
  <Card title="09 — Versioning and rotation" href="/docs/keiro/walkthrough/durable-execution/09-versioning-and-rotation" description="The generation column and #<g> stream suffix, currentGeneration, the ContinueAsNew/WorkflowRotate unwind and crash-safe rotateGeneration, restoreSeed as an ordinary step, and the patch hit/miss handler keyed on startedInFlight." />
</Cards>
