...
<Cards>
  ...
  <Card title="Durable execution" href="/docs/keiro/walkthrough/durable-execution/00-start-here" description="The Keiro.Workflow runtime: journal-and-replay over named steps, durable sleep, awakeables, child workflows, the resume worker, and snapshots." />
