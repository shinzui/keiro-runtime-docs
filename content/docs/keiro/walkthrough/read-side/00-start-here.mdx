...
<Cards>
  ...
  <Card title="03 — The read-model query path" href="/docs/keiro/walkthrough/read-side/03-the-read-model-query-path" description="runQueryWith, schema validation, and the consistency-mode wait." />
