...
<Callout type="warn">
  ...
  [Understanding durable execution](/docs/keiro/explanation/durable-execution) — though
  continue-as-new journal rotation and a versioning/patch API remain deferred.
</Callout>
