...
artifacts (zero-enumeration, B-views, the acceptors and projections) that consume
...
schema, and the transition relation. Everything an acceptor or a B-view needs is *already
