...
The non-recursive cases are the point: a literal is a constant and `TInpCtorField` reads the *input*,
...
-- TLit / TOpaqueLit / TInpCtorField / TApp1 / TArith / TApp2 recurse as above
```
